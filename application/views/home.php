...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <!-- <img src="https://www.b-cube.in/wp-content/uploads/2014/05/aditya-300x177.jpg" id="icon" alt="User Icon" /> -->
			...
			<?php }else{ ?>
							<br/>
			<?php } ?>
      <h1 style="color: #251C1C;">LOGIN</h1>
    </div>

    <!-- Login Form -->
    <form action="<?php echo base_url(); ?>main/login_validation" method="post">
      <input type="text" id="login" class="fadeIn second" name="user_email" placeholder="email">
    ...
    <div id="formFooter">
			Dont have Account?
      <a class="underlineHover" href="<?php echo base_url(); ?>main/register" style="color: blue;">Register</a>
    </div>
