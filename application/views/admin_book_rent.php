    ...
    <div class="row">
      ...
      <div class="col-md-6" style="background-color: #F0E68C; padding-top: 10px;">
        ...
        <?php foreach($consti_data->result() as $row1){ ?>
                ...
                <div class="row">
                  <div class="col-md-3">
                    <?php echo $row1->resources;?><br/>
                    <b><label>Resources</label></b>
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    <?php echo $row1->hours;?><br/>
                    <b><label>Hours/Time</label></b>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="btn" style="padding-left: 0px; margin-top: 70px;">
                  <a href="<?php echo base_url(); ?>main/admin_rent_approve/<?php echo $row1->id ?>/approve" class="btn btn-sm btn-success">Approve</a>
			            <a href="<?php echo base_url(); ?>main/admin_rent_approve/<?php echo $row1->id ?>/decline" class="btn btn-sm btn-danger">Decline</a>
                  <a href="<?php echo base_url(); ?>main/admin_rent_approve/<?php echo $row1->id ?>/done" class="btn btn-sm btn-primary">Done</a>
                </div>
